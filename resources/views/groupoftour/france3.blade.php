...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟 FRANCE LOUVRE MUSSIUM TOUR 🌟</h2>
        <p class="text-muted mb-5"><i class="bi bi-geo-alt-fill"></i> France, Beauty of Louvre Mussium</p>
    </center>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('groupoftourfrance.jpg')}}" style="height: 820px" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
...
<div class="container my-3">
  ...
  <div class="internity">
    ...
    <div class="panel">
      ...
      <p>* Breakfast: French-style breakfast with croissants, fruits, and coffee.</p>
      <p>* Transfer to hotel for check-in (Standard Check-in time: 15:00 Hrs).</p>
      <p>* Evening: Seine River cruise with welcome dinner onboard.</p>
      <p>* Overnight stay at hotel in Paris.</p>
    </div>

    <button class="accordion"><i class="fas fa-landmark"></i> DAY - 2 EIFFEL TOWER & CITY TOUR</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Visit Eiffel Tower (2nd level entry).</p>
      <p>* Panoramic Paris city tour: Arc de Triomphe, Champs-Élysées, Notre-Dame Cathedral.</p>
      <p>* Lunch at an Indian or French restaurant.</p>
      <p>* Free time for shopping or leisure walk in Parisian streets.</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-university"></i> DAY - 3 LOUVRE MUSEUM & MONTMARTRE</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Visit the Louvre Museum – see the Mona Lisa and other art masterpieces.</p>
      <p>* Lunch near the Louvre at a Paris café.</p>
      <p>* Afternoon visit to Montmartre: Explore artist square and Sacré-Cœur Basilica.</p>
      <p>* Optional: Attend a traditional French cabaret show.</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-magic"></i> DAY - 4 DISNEYLAND PARIS OR FREE DAY</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Option 1: Full-day visit to Disneyland Paris (includes park ticket).</p>
      <p>* Option 2: Free day for shopping, local exploration, or museum hopping.</p>
      <p>* Lunch as per selected activity.</p>
      <p>* Evening wrap-up dinner with local specialties.</p>
      <p>* Transfer to airport OR extend stay upon request.</p>
    </div>
  </div>
</div>
