...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟 BANGKOCK  RESERVATION-TOUR 🌟</h2>
        <p class="text-muted mb-5"><i class="bi bi-geo-alt-fill"></i>BANG KOCK</p>
    </center>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('resbankok.jpg')}}" style="height: 820px" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
...
<div class="container my-3">
  <h2>INTERNITY (DAY WISE) - BANGKOK, THAILAND</h2>
  <div class="internity">
    <button class="accordion"><i class="fas fa-plane-arrival"></i> DAY - 1 ARRIVAL IN BANGKOK</button>
    <div class="panel">
      <p>* Arrival at Suvarnabhumi International Airport, Bangkok.</p>
      <p>* Meet & greet by our Thai tour representative.</p>
      <p>* Transfer to hotel and check-in (Standard Check-in time: 14:00 Hrs).</p>
      <p>* Evening: Chao Phraya River Dinner Cruise.</p>
      <p>* Overnight stay at hotel in Bangkok.</p>
    </div>

    <button class="accordion"><i class="fas fa-temple"></i> DAY - 2 BANGKOK CITY TEMPLE TOUR</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Visit famous temples: Wat Arun (Temple of Dawn), Wat Pho (Reclining Buddha), and Wat Phra Kaew (Emerald Buddha).</p>
      <p>* Explore Grand Palace and its Royal Grounds.</p>
      <p>* Lunch at a local Thai restaurant.</p>
      <p>* Optional: Thai Massage experience.</p>
      <p>* Overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-shopping-cart"></i> DAY - 3 SAFARI WORLD & SHOPPING</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Full-day tour to Safari World & Marine Park with buffet lunch.</p>
      <p>* Witness wild animal shows and safari rides.</p>
      <p>* Evening shopping at Platinum Mall / MBK Center.</p>
      <p>* Dinner at Indian restaurant.</p>
      <p>* Overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-umbrella-beach"></i> DAY - 4 FLOATING MARKET - DEPARTURE</button>
    <div class="panel">
      <p>* Early breakfast at hotel.</p>
      <p>* Half-day excursion to Damnoen Saduak Floating Market.</p>
      <p>* Explore local souvenirs and boat rides.</p>
      <p>* Return to hotel and check out.</p>
      <p>* Transfer to the airport for return flight.</p>
    </div>
  </div>
</div>
