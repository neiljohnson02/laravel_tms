...
<body>
  ...
  <center>
    <h5 class="pt-4">
      <i class="bi bi-stars text-warning me-2"></i><span class="text-dark">GT HOLIDAYS</span> <i class="fas fa-globe-americas text-primary me-2"></i>
  <i class="fas fa-credit-card text-success me-2"></i>
  ASIA-PACKAGE PAYMENTS
    </h5>
  </center>
  <!-- search box -->
            ...
            <thead>
             ...
             <tbody>
               @foreach($payment as $tours)
                ...
                <td>
                  <!-- Delete -->
                 <form action="{{ route('packasiapayment.destroy', $tours->id) }}" method="POST" style="display:inline;" class="delete-form">
                    @csrf
                    @method('DELETE')
                  ...
                  <!-- Email -->
                  <form action="{{ route('packasiapayment.email', $tours->id) }}" method="POST" style="display:inline;">
                    @csrf
