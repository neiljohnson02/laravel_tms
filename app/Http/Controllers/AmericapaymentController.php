...
use App\Mail\AmericapaymentMail;
use Illuminate\Support\Facades\Log;
use Illuminate\Support\Facades\Mail;
use Illuminate\Support\Facades\Validator;

class AmericapaymentController extends Controller
{
    public function store(Request $request)
    {
        ...
        try {
            $payment = Americapayment::create($data);
    ...
    {
        $payment = Americapayment::latest()->get();
        return view('dashboard.americapayment', compact('payment'));
    }

    // Send payment confirmation email
    public function sendMail($id)
    {
        $tour = Americapayment::findOrFail($id);
        ...
        try {
            Mail::to($data['email'])->send(new AmericapaymentMail($data));
