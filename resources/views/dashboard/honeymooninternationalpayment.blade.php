...
<body>
  ...
  <center>
    <h5 class="pt-4">
      <i class="bi bi-clipboard-data text-dark me-2"></i>  <span class="text-dark">GT HOLIDAYS</span> INTERNATIONAL HONEYMOON PAYMENTS
    </h5>
  </center>
  <!-- search box -->
            ...
            <thead>
             ...
             <tbody>
               @foreach($payment as $tours)
                ...
                <td>
                  <!-- Delete -->
                 <form action="{{ route('honeymooninternationalpayment.destroy', $tours->id) }}" method="POST" style="display:inline;" class="delete-form">
                    @csrf
                    @method('DELETE')
                  ...
                  <!-- Email -->
                  <form action="{{ route('honeymooninternationalpayment.email', $tours->id) }}" method="POST" style="display:inline;">
                    @csrf
