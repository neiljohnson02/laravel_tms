...
<center><h3 class="pt-5">India Packages </h3>
  <div class="container pt-2 my-4">
  <div class="row row-cols-1   row-cols-md-4 g-4">
  <div class="col">
  <div class="card">
  <a href="{{route('package.packindia1')}}"><img src="{{asset('bigtemple1.jpeg')}}" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
  <h5 class="card-title"><p class="text-center"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M480-480q33 0 56.5-23.5T560-560q0-33-23.5-56.5T480-640q-33 0-56.5 23.5T400-560q0 33 23.5 56.5T480-480Zm0 294q122-112 181-203.5T720-552q0-109-69.5-178.5T480-800q-101 0-170.5 69.5T240-552q0 71 59 162.5T480-186Zm0 106Q319-217 239.5-334.5T160-552q0-150 96.5-239T480-880q127 0 223.5 89T800-552q0 100-79.5 217.5T480-80Zm0-480Z"/></svg>BigTemple  Tamilnadu , India</h5>
...
<div class="col">
  <div class="card">
  <a href="{{route('package.packindia2')}}"><img src="{{asset('kerala3.jpeg')}}" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
  <h5 class="card-title"><p class="text-center"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M480-480q33 0 56.5-23.5T560-560q0-33-23.5-56.5T480-640q-33 0-56.5 23.5T400-560q0 33 23.5 56.5T480-480Zm0 294q122-112 181-203.5T720-552q0-109-69.5-178.5T480-800q-101 0-170.5 69.5T240-552q0 71 59 162.5T480-186Zm0 106Q319-217 239.5-334.5T160-552q0-150 96.5-239T480-880q127 0 223.5 89T800-552q0 100-79.5 217.5T480-80Zm0-480Z"/></svg>Munnar  Kerala, India</h5>
  <p class="card-text text-center" ><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="m612-292 56-56-148-148v-184h-80v216l172 172ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-400Zm0 320q133 0 226.5-93.5T800-480q0-133-93.5-226.5T480-800q-133 0-226.5 93.5T160-480q0 133 93.5 226.5T480-160Z"/></svg>3 Nights and 4 Days</p>
  </div>
  </div>
</div>
<div class="col">
  <div class="card">
  <a href="{{route('package.packindia3')}}"><img src="{{asset('group of tour 5.jpeg')}}" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
...
<div class="col">
  <div class="card">
  <a href="{{route('package.packindia4')}}"><img src="{{asset('group of tour 6.jpg')}}" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
...
<div class="col">
<div class="card">
<a href="{{route('package.packindia5')}}"><img src="{{asset('honeymooncard1.jpeg')}}" style="height: 350px" class="card-img-top" alt="..."></a>
<div class="card-body">
...
<div class="col">
<div class="card">
<a href="{{route('package.packindia6')}}"><img src="{{asset('honeymooncard2.jpeg')}}" style="height: 350px" class="card-img-top" alt="..."></a>
<div class="card-body">
...
<div class="col">
<div class="card">
<a href="{{route('package.packindia7')}}"><img src="{{asset('honeymooncard3.jpeg')}}" style="height: 350px" class="card-img-top" alt="..."></a>
<div class="card-body">
...
<div class="col">
<div class="card">
<a href="{{route('package.packindia8')}}"><img src="{{asset('honeymooncard4.jpeg')}}" style="height: 350px" class="card-img-top" alt="..."></a>
<div class="card-body">
...
<div class="col">
<div class="card">
<a href="{{route('package.packindia9')}}"><img src="{{asset('honeymooncard5.jpeg')}}" style="height: 350px" class="card-img-top" alt="..."></a>
<div class="card-body">
...
<div class="col">
<div class="card">
<a href="{{route('package.packindia10')}}"><img src="{{asset('honeymooncard6 (2).jpeg')}}" style="height: 350px" class="card-img-top" alt="..."></a>
<div class="card-body">
...
<div class="col">
  <div class="card">
    <a href="{{route('package.packindia11')}}"><img src="{{asset('honeymooncard7 (2).jpeg')}}" style="height: 350px"  class="card-img-top" alt="..."></a>
    <div class="card-body">
...
<div class="col">
  <div class="card">
    <a href="{{route('package.packindia12')}}"><img src="{{asset('honeymooncard8.jpeg')}}" style="height: 350px"  class="card-img-top" alt="..."></a>
    <div class="card-body">
...
<div class="col">
<div class="card">
<a href="{{route('package.packindia13')}}"><img src="{{asset('honeymooncard10 (2).jpeg')}}" style="height: 350px" class="card-img-top" alt="..."></a>
<div class="card-body">
...
<div class="col">
<div class="card">
<a href="{{route('package.packindia14')}}"> <img src="{{asset('honeymooncard12.jpg')}}" style="height: 350px" class="card-img-top" alt="..."></a>
<div class="card-body">
...
<div class="col">
<div class="card">
<a href="{{route('package.packindia15')}}"><img src="{{asset('honeymooncard13.jpeg')}}" style="height: 350px" class="card-img-top" alt="..."></a>
<div class="card-body">
...
<div class="col">
  <div class="card">
   <a href="{{route('package.packindia16')}}"> <img src="{{asset('honeymooncard14.jpeg')}}" style="height: 350px" class="card-img-top" alt="..."></a>
    <div class="card-body">
...
<div class="container pt-2 my-4">
  ...
  <div class="col">
  <div class="card">
  <a href="{{route('package.packindia17')}}"><img src="{{asset('packind1.jpeg')}}" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
  <h5 class="card-title"><p class="text-center"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M480-480q33 0 56.5-23.5T560-560q0-33-23.5-56.5T480-640q-33 0-56.5 23.5T400-560q0 33 23.5 56.5T480-480Zm0 294q122-112 181-203.5T720-552q0-109-69.5-178.5T480-800q-101 0-170.5 69.5T240-552q0 71 59 162.5T480-186Zm0 106Q319-217 239.5-334.5T160-552q0-150 96.5-239T480-880q127 0 223.5 89T800-552q0 100-79.5 217.5T480-80Zm0-480Z"/></svg>HawaMahal Jaipur, India</h5>
  <p class="card-text text-center" ><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="m612-292 56-56-148-148v-184h-80v216l172 172ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-400Zm0 320q133 0 226.5-93.5T800-480q0-133-93.5-226.5T480-800q-133 0-226.5 93.5T160-480q0 133 93.5 226.5T480-160Z"/></svg>3 Nights and 4 Days</p>
  </div>
  </div>
</div>
<div class="col">
  <div class="card">
 <a href="{{route('package.packindia18')}}"> <img src="{{asset('packind2.jpeg')}}" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
  <h5 class="card-title"><p class="text-center"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M480-480q33 0 56.5-23.5T560-560q0-33-23.5-56.5T480-640q-33 0-56.5 23.5T400-560q0 33 23.5 56.5T480-480Zm0 294q122-112 181-203.5T720-552q0-109-69.5-178.5T480-800q-101 0-170.5 69.5T240-552q0 71 59 162.5T480-186Zm0 106Q319-217 239.5-334.5T160-552q0-150 96.5-239T480-880q127 0 223.5 89T800-552q0 100-79.5 217.5T480-80Zm0-480Z"/></svg>Gate Way Of India,Mumbai India</h5>
  <p class="card-text text-center" ><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="m612-292 56-56-148-148v-184h-80v216l172 172ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-400Zm0 320q133 0 226.5-93.5T800-480q0-133-93.5-226.5T480-800q-133 0-226.5 93.5T160-480q0 133 93.5 226.5T480-160Z"/></svg>3 Nights and 4 Days</p>
  </div>
  </div>
</div>
<div class="col">
  <div class="card">
  <a href="{{route('package.packindia19')}}"><img src="{{asset('packind3.jpeg')}}" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
  <h5 class="card-title"><p class="text-center"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M480-480q33 0 56.5-23.5T560-560q0-33-23.5-56.5T480-640q-33 0-56.5 23.5T400-560q0 33 23.5 56.5T480-480Zm0 294q122-112 181-203.5T720-552q0-109-69.5-178.5T480-800q-101 0-170.5 69.5T240-552q0 71 59 162.5T480-186Zm0 106Q319-217 239.5-334.5T160-552q0-150 96.5-239T480-880q127 0 223.5 89T800-552q0 100-79.5 217.5T480-80Zm0-480Z"/></svg>Howrah Bridge,Kolkata India </h5>
  <p class="card-text text-center" ><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="m612-292 56-56-148-148v-184h-80v216l172 172ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-400Zm0 320q133 0 226.5-93.5T800-480q0-133-93.5-226.5T480-800q-133 0-226.5 93.5T160-480q0 133 93.5 226.5T480-160Z"/></svg>3 Nights and 4 Days</p>
  </div>
  </div>
</div>
  ...
  <div class="col">
    <div class="card">
     <a href="{{route('package.packindia20')}}"> <img src="{{asset('packind4.jpeg')}}" style="height: 350px"class="card-img-top" alt="..."></a>
      <div class="card-body">
      <h5 class="card-title"><p class="text-center"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M480-480q33 0 56.5-23.5T560-560q0-33-23.5-56.5T480-640q-33 0-56.5 23.5T400-560q0 33 23.5 56.5T480-480Zm0 294q122-112 181-203.5T720-552q0-109-69.5-178.5T480-800q-101 0-170.5 69.5T240-552q0 71 59 162.5T480-186Zm0 106Q319-217 239.5-334.5T160-552q0-150 96.5-239T480-880q127 0 223.5 89T800-552q0 100-79.5 217.5T480-80Zm0-480Z"/></svg>Bengaluru,India</h5>
  <p class="card-text text-center" ><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="m612-292 56-56-148-148v-184h-80v216l172 172ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-400Zm0 320q133 0 226.5-93.5T800-480q0-133-93.5-226.5T480-800q-133 0-226.5 93.5T160-480q0 133 93.5 226.5T480-160Z"/></svg>3 Nights and 4 Days</p>
      </div>
    </div>
  </div>
