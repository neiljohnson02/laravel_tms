...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟 ITALY CITY OF ROME TOUR 🌟</h2>
        <p class="text-muted mb-5"><i class="bi bi-geo-alt-fill"></i> ITALY, THE CITY OF ROME</p>
    </center>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('groupoftourrome.jpg')}}" style="height: 820px" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
...
<div class="container my-3">
  ...
  <div class="internity">
    <button class="accordion"><i class="fas fa-plane-arrival"></i> DAY - 1 ARRIVE IN ROME</button>
    <div class="panel">
      <p>* Arrival at Rome Fiumicino Airport.</p>
      <p>* Tour representative meets & greets you.</p>
      <p>* Breakfast: Italian pastries and coffee served with beverages.</p>
      <p>* Transfer to hotel for check-in (Standard Check-in time: 14:00 Hrs).</p>
      <p>* Evening: Leisure walk around Piazza Navona and the Pantheon.</p>
      <p>* Dinner at a traditional Roman trattoria.</p>
      <p>* Overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-landmark"></i> DAY - 2 ANCIENT ROME & VATICAN CITY</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Visit Colosseum and Roman Forum guided tour.</p>
      <p>* Explore Palatine Hill.</p>
      <p>* Lunch at local Italian restaurant.</p>
      <p>* Afternoon tour of Vatican Museums, Sistine Chapel & St. Peter’s Basilica.</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-fountain"></i> DAY - 3 ROME CITY TOUR & CULTURE</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Visit Trevi Fountain, Spanish Steps, and Piazza di Spagna.</p>
      <p>* Explore Villa Borghese Gardens & Gallery (optional).</p>
      <p>* Lunch at a local café.</p>
      <p>* Free afternoon for shopping or leisure.</p>
      <p>* Dinner at a rooftop restaurant overlooking the city.</p>
      <p>* Overnight stay at hotel.</p>
    </div>
    ...
    <div class="panel">
      ...
      <p>* Free time for last-minute sightseeing or shopping.</p>
      <p>* Transfer to Rome Airport.</p>
      <p>* Departure from Rome.</p>
    </div>
  </div>
</div>
