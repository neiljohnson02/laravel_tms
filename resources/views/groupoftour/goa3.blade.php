...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟 India - GOA🌟</h2>
        <p class="text-muted mb-5"><i class="bi bi-geo-alt-fill"></i>India, Chill With GOA🌟</p>
    </center>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('groupoftourgoa2.jpg')}}"  style="height: 820px" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
...
<div class="container my-3">
  ...
  <div class="internity">
    ...
    <div class="panel">
      <p>* Arrival at Goa Airport.</p>
      <p>* Meet & greet by our tour representative.</p>
      <p>* Breakfast: Traditional Goan and continental items served with beverages.</p>
      <p>* Transfer to hotel for check-in (Standard Check-in time: 14.00 Hrs).</p>
      <p>* Evening leisure walk on the beach.</p>
      <p>* Overnight stay at hotel in North Goa.</p>
    </div>

    <button class="accordion"><i class="fas fa-umbrella-beach"></i> DAY - 2 NORTH GOA SIGHTSEEING</button>
    <div class="panel">
      <p>* Morning breakfast at hotel.</p>
      <p>* Explore Calangute Beach, Baga Beach, Anjuna Beach.</p>
      <p>* Visit Aguada Fort and Chapora Fort for scenic views.</p>
      <p>* Lunch at a beach shack with Goan seafood specialties.</p>
      <p>* Evening beach leisure time or water sports (optional).</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-church"></i> DAY - 3 OLD GOA - CHURCHES & HERITAGE TOUR</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Visit Old Goa: Basilica of Bom Jesus, Se Cathedral, Church of St. Francis of Assisi.</p>
      <p>* Explore Fontainhas – Latin Quarter of Panaji.</p>
      <p>* Lunch at a local Portuguese-style restaurant.</p>
      <p>* River cruise on Mandovi River in the evening (with DJ & Goan folk dance).</p>
      <p>* Overnight stay at hotel in Panaji.</p>
    </div>

    <button class="accordion"><i class="fas fa-spa"></i> DAY - 4 SOUTH GOA & RELAXATION</button>
    <div class="panel">
      <p>* Breakfast at hotel and check-out.</p>
      <p>* Explore South Goa: Colva Beach, Palolem Beach, and Dona Paula View Point.</p>
      <p>* Visit Mangeshi Temple and Shantadurga Temple.</p>
      <p>* Lunch at beachside café in Palolem.</p>
      <p>* Leisure time or Ayurvedic spa session (optional).</p>
      <p>* Transfer to airport for departure OR extended stay on request.</p>
    </div>
  </div>
</div>
