...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟 RUSSIA MOSCOW RESERVATION-TOUR 🌟</h2>
        <p class="text-muted mb-5"><i class="bi bi-geo-alt-fill"></i>RUSSIA , MOSCOW</p>
    </center>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('resmoscow.jpg')}}" style="height: 820px" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
...
<div class="container my-3">
  <h2>INTERNITY (DAY WISE) - MOSCOW, RUSSIA</h2>
  <div class="internity">
    <button class="accordion"><i class="fas fa-plane-arrival"></i> DAY - 1 ARRIVAL IN MOSCOW</button>
    <div class="panel">
      <p>* Arrival at Sheremetyevo International Airport, Moscow.</p>
      <p>* Meet & greet by our Russian tour representative.</p>
      <p>* Breakfast: Continental breakfast at local café or airport lounge.</p>
      <p>* Transfer to hotel for check-in (Standard Check-in time: 15:00 Hrs).</p>
      <p>* Evening: Welcome dinner at a Russian restaurant.</p>
      <p>* Overnight stay at hotel in Moscow.</p>
    </div>

    <button class="accordion"><i class="fas fa-landmark"></i> DAY - 2 KREMLIN & RED SQUARE TOUR</button>
    <div class="panel">
      <p>* Morning breakfast at hotel.</p>
      <p>* Visit Red Square and St. Basil’s Cathedral.</p>
      <p>* Guided tour of the Moscow Kremlin, Armoury Chamber & Cathedral Square.</p>
      <p>* Lunch at a Russian/Indian fusion restaurant.</p>
      <p>* Explore GUM Department Store and historical center.</p>
      <p>* Dinner and Overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-subway"></i> DAY - 3 MOSCOW METRO TOUR & ARBAT STREET</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Tour the iconic Moscow Metro – known as the “Underground Palace.”</p>
      <p>* Visit Victory Park and Poklonnaya Hill (War Memorial).</p>
      <p>* Lunch at a local restaurant.</p>
      <p>* Walk along Old Arbat Street for souvenirs and street art.</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-building"></i> DAY - 4 SPARROW HILLS - MOSCOW RIVER CRUISE</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Visit Moscow State University and panoramic views at Sparrow Hills.</p>
      <p>* Take a scenic cruise on the Moskva River (optional: Radisson Cruise).</p>
      <p>* Lunch on board or at nearby riverside café.</p>
      <p>* Evening leisure/shopping at Izmailovsky Market.</p>
      <p>* Farewell dinner and overnight stay at hotel.</p>
    </div>
  </div>
</div>
