...
<div class="container mt-3">
  ...
  <div class="carusel bg-light p-4 rounded shadow" style="resize: both; overflow: auto;">
    <div class="form">
      <form id="americaform" method="POST">
        {{csrf_field()}}
      ...
      <!-- Premium Package -->
        <div class="form-group mb-3 col-md-8 ms-5">
          ...
          <select name="package" class="form-control" required>
           <option value="bigtemple_tamilnadu">Big Temple, Tamil Nadu – 12k</option>
           <option value="munnar_kerala">Munnar, Kerala – 14k</option>
           <option value="tajmahal_agra">India, Taj Mahal – 18k</option>
           <option value="goa_beach">India, Beach of Goa – 16k</option>
           <option value="kashmir_valley">India, Kashmir – 20k</option>
           <option value="manali_himachal">India, Manali – 17k</option>
           <option value="alleppey_kerala">India, Alleppey – 13k</option>
           <option value="ooty_tamilnadu">India, Ooty – 12k</option>
           <option value="dharamshala_hp">India, Dharamshala – 15k</option>
           <option value="shimla_hp">India, Shimla – 14k</option>
           <option value="auli_uttarakhand">India, Auli – 16k</option>
           <option value="andaman_nicobar">India, Andaman & Nicobar – 22k</option>
           <option value="lakshadweep_island">India, Lakshadweep Island – 23k</option>
           <option value="darjeeling_wb">India, Darjeeling, West Bengal – 14k</option>
           <option value="goa_beach2">India, Goa Beach – 16k</option>
           <option value="ladakh_jk">India, Ladakh – 24k</option>
           <option value="hawamahal_jaipur">Hawa Mahal, Jaipur, India – 13k</option>
           <option value="gatewayofindia_mumbai">Gateway of India, Mumbai, India – 12k</option>
           <option value="howrahbridge_kolkata">Howrah Bridge, Kolkata, India – 11k</option>
           <option value="bengaluru_karnataka">Bengaluru, India – 10k</option>
          </select>
...
$(document).ready(function(){
  ...
  $('#americaform').submit(function(e){
    e.preventDefault();
    $.ajax({
      url: "{{ route('packamerica.tour') }}",
      type: "POST",
      data: $(this).serialize(),
  ...
  function premiumTours(){
    $.get("{{ route('packamerica.tours') }}", function(data){
...
$('#paymentform').on('submit', function(e) {
    ...
    $.ajax({
        type: 'POST',
        url: "{{ route('packamerica-payment.store') }}",
        data: formData,
        contentType: false,
        processData: false,
        success: function(response) {
...
function loadPremiumPayments() {
    $.get("{{ route('packamerica.packamericas') }}", function (data) {
        $('#tourTableContainer').html(data);
    });
}
</script>
