...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟 INDIA GOA  RESERVATION-TOUR 🌟</h2>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('resgoa.jpg')}}" style="height: 820px" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
...
<div class="container my-3">
  <h2>GOA TOUR (DAY WISE)</h2>
  <div class="internity">

    <button class="accordion"><i class="fas fa-plane-arrival"></i> DAY - 1 ARRIVE IN GOA</button>
    <div class="panel">
      <p>* Arrival at Goa Airport / Railway Station.</p>
    ...
    <button class="accordion"><i class="fas fa-umbrella-beach"></i> DAY - 2 NORTH GOA SIGHTSEEING</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Full-day sightseeing of North Goa.</p>
      <p>* Visit: Fort Aguada, Calangute Beach, Baga Beach, Anjuna Beach.</p>
      <p>* Optional water sports activities.</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-archway"></i> DAY - 3 SOUTH GOA HERITAGE TOUR</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Explore South Goa: Se Cathedral, Basilica of Bom Jesus, Mangueshi Temple.</p>
      <p>* Visit Dona Paula, Miramar Beach, and Panjim market.</p>
      <p>* Optional river cruise on Mandovi River in the evening.</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-glass-martini-alt"></i> DAY - 4 LEISURE & DEPARTURE</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Free time for shopping or relaxing at the beach.</p>
      <p>* Check-out and transfer to Goa Airport / Railway Station.</p>
      <p>* Tour ends with beautiful memories of Goa.</p>
    </div>
