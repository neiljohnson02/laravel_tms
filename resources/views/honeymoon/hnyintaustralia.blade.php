...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟 AUSTRALIA NINGALOO REEF PREMIUM TOUR 🌟</h2>
        <p class="text-muted mb-5"><i class="bi bi-geo-alt-fill"></i> AUSTRALIA, NINGALOO REEF</p>
    </center>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('hnyint10.jpg')}}" style="height: 820px" class="card-img-top" alt="...">
</div>
