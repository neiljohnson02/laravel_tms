...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟GHAANA TOUR 🌟</h2>
        <p class="text-muted mb-5"><i class="bi bi-geo-alt-fill"></i>GHAANA</p>
    </center>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('packafrica10.jpg')}}" style="height: 820px" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
