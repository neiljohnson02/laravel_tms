...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟 INDONESIA BALI  RESERVATION-TOUR 🌟</h2>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('resbali.jpg')}}" style="height: 820px" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
...
<div class="container my-3">
  <h2>INTERNITY (DAY WISE) - BALI, INDONESIA</h2>
  <div class="internity">
    <button class="accordion"><i class="fas fa-plane-arrival"></i> DAY - 1 ARRIVE IN BALI</button>
    <div class="panel">
      <p>* Arrival at Ngurah Rai International Airport, Denpasar, Bali.</p>
      <p>* Meet & greet by our tour representative.</p>
      <p>* Transfer to hotel and check-in (Standard Check-in: 14:00 Hrs).</p>
      <p>* Enjoy sunset at Kuta Beach.</p>
      <p>* Dinner at a beachfront restaurant.</p>
      <p>* Overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-water"></i> DAY - 2 WATER SPORTS & ULUWATU TEMPLE</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Enjoy water sports at Tanjung Benoa Beach (Banana Boat, Jet Ski, Parasailing).</p>
      <p>* Visit Garuda Wisnu Kencana Cultural Park.</p>
      <p>* Sunset visit to Uluwatu Temple.</p>
      <p>* Witness Kecak Dance performance.</p>
      <p>* Dinner at Jimbaran Bay.</p>
      <p>* Overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-mountain"></i> DAY - 3 KINTAMANI VOLCANO & UBUD</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Visit Kintamani to see Mount Batur Volcano view.</p>
      <p>* Stop at coffee plantations for a Luwak coffee experience.</p>
      <p>* Explore Ubud Art Market and Monkey Forest.</p>
      <p>* Lunch at a scenic restaurant overlooking the volcano.</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-umbrella-beach"></i> DAY - 4 LEISURE & DEPARTURE</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Free time for beach relaxation or spa (optional).</p>
      <p>* Check-out and transfer to the airport.</p>
      <p>* Fly back home with unforgettable memories of Bali.</p>
    </div>
  </div>
</div>
