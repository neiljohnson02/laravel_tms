...
<body>
  ...
  <h1 class="contact-heading pt-4">Travel Agency - Tirunelveli</h1>

  <div class="contact-section">
    <div class="contact-left">
      <img src="{{ asset('contact1.jpg') }}" style="height: 600px" alt="Company Building">
    ...
    <p><i class="fas fa-map-marker-alt me-2 text-warning"></i><strong>Address:</strong> 6a/13A Vannarapettai 1st Street, Thoothukudi, Tamilnadu, India</p>
    ...
    <div class="contact-right">
        <iframe id="map-canvas" class="map_part" width="425" height="500" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
        src="https://maps.google.com/maps?width=100%&amp;height=100%&amp;hl=en&amp;q=tirunelveli&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" style="height: 820px">
      </iframe>
    </div>
  </div>
...
<div class="container pt-4">
   <div class="row">
      <div class="col-12">
         <h2 class="fw-bold text-warning">What Should You Expect from a Travel Agency in Tirunelveli?</h2>
         <p class="mt-3 text-secondary">
         ...
         <p class="text-secondary">
            Looking for a truly hassle-free travel experience? Visit GT Holidays, the best-rated travel agency in Tirunelveli. Sit back, relax, and leave the details to us. Your dream vacation is just a call away.
         </p>
         <p class="text-secondary">
