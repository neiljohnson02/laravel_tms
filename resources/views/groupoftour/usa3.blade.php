...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟 USA STATUE OF LIBERTY TOUR 🌟</h2>
        <p class="text-muted mb-5"><i class="bi bi-geo-alt-fill"></i> USA, United State of America</p>
    </center>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('groupoftourusa.jpg')}}" style="height: 820px" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
...
<div class="container my-3">
  ...
  <div class="internity">
    <button class="accordion"><i class="fas fa-plane-arrival"></i> DAY - 1 ARRIVE IN NEW YORK</button>
    <div class="panel">
      <p>* Arrival at John F. Kennedy (JFK) or Newark Airport.</p>
      <p>* Meet & greet by our tour representative.</p>
      <p>* Breakfast: American-style with eggs, toast, fruit, and coffee.</p>
      <p>* Transfer to hotel for check-in (Standard Check-in time: 15:00 Hrs).</p>
      <p>* Evening: Times Square orientation tour and welcome dinner.</p>
      <p>* Overnight stay at hotel in New York City.</p>
    </div>

    <button class="accordion"><i class="fas fa-city"></i> DAY - 2 STATUE OF LIBERTY & NYC TOUR</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Ferry ride to Liberty Island to visit the Statue of Liberty.</p>
      <p>* Explore Ellis Island Immigration Museum (optional).</p>
      <p>* Lunch at an Indian or American restaurant.</p>
      <p>* Afternoon panoramic city tour: Wall Street, 9/11 Memorial, One World Observatory.</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-landmark"></i> DAY - 3 EMPIRE STATE BUILDING & BROOKLYN</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Morning visit to the Empire State Building Observation Deck.</p>
      <p>* Explore 5th Avenue shopping and Bryant Park.</p>
      <p>* Lunch at a local restaurant.</p>
      <p>* Evening stroll on Brooklyn Bridge and DUMBO area visit.</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-museum"></i> DAY - 4 MUSEUM TOUR & CENTRAL PARK</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Visit the American Museum of Natural History or The Met Museum.</p>
      <p>* Relaxing walk or carriage ride in Central Park.</p>
      <p>* Lunch at a Central Park café.</p>
      <p>* Final evening shopping or optional Broadway show.</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>
  </div>
</div>
