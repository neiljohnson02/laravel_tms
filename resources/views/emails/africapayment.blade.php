...
<head>
    ...
    <style>
        ...
        .email-header {
            background: #3498db; /* european blue */
            color: #fff;
            padding: 25px;
            text-align: center;
        }
...
<body>
   ...
   <div class="email-body" style="font-family: Arial, sans-serif; font-size: 15px; color: #333;">
    ...
    <p style="margin-top: 20px;">✅ Our team will get in touch with you shortly to finalize your amazing journey through Europe!</p>

    <p>🌐 Want to discover more travel packages? Visit 👉 <a href="https://www.gtholidays.in" target="_blank">www.gtholidays.in</a></p>

    <p>✈️ Thank you for choosing <strong>GTHolidays</strong>. Your European adventure is just around the corner!</p>
</div>
