...
class IndiapaymentController extends Controller
{
     public function store(Request $request)
    {
        ...
        try {
            $payment = Indiapayment::create($data);
    ...
    {
        $payment = Indiapayment::latest()->get();
        return view('dashboard.indiapayment', compact('payment'));
    }

    // Send payment confirmation email
    public function sendMail($id)
    {
        $tour = Indiapayment::findOrFail($id);
        ...
        try {
            Mail::to($data['email'])->send(new IndiapaymentMail($data));
