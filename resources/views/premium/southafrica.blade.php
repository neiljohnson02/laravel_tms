...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('premiumsouthafrica1.jpg')}}" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
  <img src="{{asset('premiumsouthafrica2.jpg')}}" class="card-img-top" alt="...">
</div>
</div>
...
$(document).ready(function(){
  ...
  function premiumTours(){
    $.get("{{ route('premium.tours') }}", function(data){
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="travel_group" class="form-control" required>
                                ...
                                <option value="dubai">Dubai - ₹50,000</option>
                                <option value="france">France - ₹70,000</option>
                                <option value="maldives">Maldives - ₹65,000</option>
                                <option value="germany">Germany - ₹75,000</option>
                                <option value="tajmahal">Taj Mahal - ₹40,000</option>
                                <option value="southafrica">South Africa - ₹80,000</option>
                            </select>
                        </div>
...
$('#paymentform').on('submit', function(e) {
    ...
    $.ajax({
        type: 'POST',
        url: "{{ route('premium-payment.store') }}",
        data: formData,
        contentType: false,
        processData: false,
        success: function(response) {
...
function loadPremiumPayments() {
    $.get("{{ route('payment.premiumtour') }}", function (data) {
        $('#tourTableContainer').html(data);
    });
}
</script>
