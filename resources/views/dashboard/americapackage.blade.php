        ...
        <tr>
            <tbody>
                @forelse($tour as $tours)
                  ...
                  <!-- Delete -->
                 <form action="{{ route('packamerica.destroy', $tours->id) }}" method="POST" style="display:inline;" class="delete-form">
                    @csrf
                    @method('DELETE')
                  ...
                  <!-- Email -->
                  <form action="{{ route('packamerica.email', $tours->id) }}" method="POST" style="display:inline;">
                    @csrf
