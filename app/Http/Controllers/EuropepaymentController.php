...
use App\Mail\EuropepaymentMail;
use Illuminate\Support\Facades\Log;
use Illuminate\Support\Facades\Mail;
use Illuminate\Support\Facades\Validator;

class EuropepaymentController extends Controller
{
      public function store(Request $request)
    {
        ...
        try {
            $payment = Europepayment::create($data);
    ...
    {
        $payment = Europepayment::latest()->get();
        return view('dashboard.europepayment', compact('payment'));
    }

    // Send payment confirmation email
    public function sendMail($id)
    {
        $tour = Europepayment::findOrFail($id);
        ...
        try {
            Mail::to($data['email'])->send(new EuropepaymentMail($data));
