            ...
            <tbody>
                @forelse($tour as $tours)
                 ...
                 <td>
                  ...
                  <!-- Delete -->
                 <form action="{{ route('premiumtour.destroy', $tours->id) }}" method="POST" style="display:inline;" class="delete-form">
                    @csrf
                    @method('DELETE')
                  ...
                  <!-- Email -->
                  <form action="{{ route('premiumtour.email', $tours->id) }}" method="POST" style="display:inline;">
                    @csrf
