...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟 JAPAN TOKYO RESERVATION-TOUR 🌟</h2>
        <p class="text-muted mb-5"><i class="bi bi-geo-alt-fill"></i> Japan , Tokyo</p>
    </center>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('restokyo.jpg')}}" style="height: 820px" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
...
<div class="container my-3">
  <h2>INTERNITY (DAY WISE) – JAPAN (TOKYO)</h2>
  <div class="internity">
    <button class="accordion"><i class="fas fa-plane-arrival"></i> DAY - 1 ARRIVE IN TOKYO</button>
    <div class="panel">
      <p>* Arrival at Narita / Haneda International Airport.</p>
      <p>* Meet and greet by our local tour representative.</p>
      <p>* Transfer to hotel and check-in (Standard check-in time: 15:00 hrs).</p>
      <p>* Evening visit to Odaiba (optional: TeamLab Planets or shopping).</p>
      <p>* Dinner at local restaurant.</p>
      <p>* Overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-city"></i> DAY - 2 TOKYO CITY TOUR</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Visit Asakusa Temple & Nakamise Shopping Street.</p>
      <p>* Photo stop at Tokyo Skytree.</p>
      <p>* Lunch at Indian or Japanese restaurant.</p>
      <p>* Visit Meiji Shrine and Harajuku Street.</p>
      <p>* Explore Shibuya Crossing & Hachiko Statue.</p>
      <p>* Dinner and Overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-mountain"></i> DAY - 3 MT. FUJI & HAKONE</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Proceed to Mt. Fuji 5th Station (subject to weather conditions).</p>
      <p>* Enjoy Lake Ashi cruise in Hakone.</p>
      <p>* Ride the Hakone Ropeway for panoramic views.</p>
      <p>* Lunch at a local restaurant.</p>
      <p>* Return to Tokyo by evening.</p>
      <p>* Dinner and Overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-store"></i> DAY - 4 SHOPPING & DEPARTURE</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Free time for shopping at Ginza or Shinjuku area.</p>
      <p>* Check out and transfer to the airport.</p>
      <p>* Fly back with wonderful memories of Japan.</p>
    </div>
  </div>
</div>
