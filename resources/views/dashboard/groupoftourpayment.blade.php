...
<body>
  ...
  <center>
    <h5 class="pt-4">
       <i class="bi bi-clipboard-data text-dark me-2"></i>  <span class="text-dark">  GT HOLIDAYS</span> &nbsp;&nbsp;Group Of Tour Payment
    </h5>
  </center>
  <!-- search box -->
            ...
            <thead>
             ...
             <tbody>
               @foreach($payment as $tours)
                ...
                <td>
                  <!-- Delete -->
                 <form action="{{ route('groupoftourpayment.destroy', $tours->id) }}" method="POST" style="display:inline;" class="delete-form">
                    @csrf
                    @method('DELETE')
                  ...
                  <!-- Email -->
                  <form action="{{ route('groupoftourpayment.email', $tours->id) }}" method="POST" style="display:inline;">
                    @csrf
