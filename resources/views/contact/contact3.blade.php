...
<body>
  ...
  <div class="contact-section">
    ...
    <div class="contact-right">
        <iframe id="map-canvas" class="map_part border-theme rounded" width="100%" height="500" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" 
                src="https://maps.google.com/maps?q=erode&z=14&output=embed" style="height: 820px">
            </iframe>
    </div>
  </div>
