...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟 India  🌟</h2>
        <p class="text-muted mb-5"><i class="bi bi-geo-alt-fill"></i> India, The Beauty of Tajmahal </p>
    </center>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('groupoftourtajmahal.jpg')}}" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
...
<div class="container my-3">
  ...
  <div class="internity">
    <button class="accordion"><i class="fas fa-plane-arrival"></i> DAY - 1 ARRIVE IN DELHI</button>
    <div class="panel">
      <p>* Arrival at Indira Gandhi International Airport, Delhi.</p>
      <p>* Meet & greet by our tour representative.</p>
      <p>* Breakfast: Indian and continental items served with beverages.</p>
      <p>* Transfer to hotel for check-in (Standard Check-in time: 15.00 Hrs).</p>
      <p>* Evening: Visit India Gate and enjoy a welcome dinner.</p>
      <p>* Overnight stay at hotel in Delhi.</p>
    </div>

    <button class="accordion"><i class="fas fa-city"></i> DAY - 2 DELHI CITY TOUR</button>
    <div class="panel">
      <p>* Morning breakfast at hotel.</p>
      <p>* Full-day city tour: Visit Qutub Minar, Humayun’s Tomb, Lotus Temple, Red Fort.</p>
      <p>* Rickshaw ride in Chandni Chowk market.</p>
      <p>* Lunch at Indian Restaurant.</p>
      <p>* Visit Raj Ghat and President House (Drive Past).</p>
      <p>* Dinner and Overnight stay at hotel in Delhi.</p>
    </div>

    <button class="accordion"><i class="fas fa-university"></i> DAY - 3 AGRA - TAJ MAHAL</button>
    <div class="panel">
      <p>* Breakfast and check-out from hotel.</p>
      <p>* Drive to Agra (Approx. 4 hrs).</p>
      <p>* Visit the majestic Taj Mahal – One of the Seven Wonders of the World.</p>
      <p>* Lunch at local restaurant.</p>
      <p>* Visit Agra Fort and Mehtab Bagh (for a sunset view of Taj Mahal).</p>
      <p>* Check-in to Agra hotel and dinner.</p>
      <p>* Overnight stay at hotel in Agra.</p>
    </div>

    <button class="accordion"><i class="fas fa-landmark"></i> DAY - 4 JAIPUR VIA FATEHPUR SIKRI</button>
    <div class="panel">
      <p>* Breakfast and check-out from hotel.</p>
      <p>* Drive to Jaipur via Fatehpur Sikri – a UNESCO World Heritage Site.</p>
      <p>* Visit Buland Darwaza and Jama Masjid at Fatehpur Sikri.</p>
      <p>* Lunch en route at Indian restaurant.</p>
      <p>* Arrive in Jaipur and check-in to hotel.</p>
      <p>* Dinner and Overnight stay at hotel in Jaipur.</p>
    </div>
  </div>
</div>
