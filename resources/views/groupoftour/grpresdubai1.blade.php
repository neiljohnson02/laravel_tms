...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('resdubai1.jpg')}}" style="height: 820px" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
...
<div class="container my-3">
  <h2>TAMILNADU BIG TEMPLE (DAY WISE)</h2>
  <div class="internity">
    <button class="accordion"><i class="fas fa-map-marker-alt"></i> DAY - 1 ARRIVAL AT THANJAVUR</button>
    <div class="panel">
      <p>* Arrival at Thanjavur Railway Station / Bus Stand.</p>
      <p>* Meet & Greet by our tour representative.</p>
      <p>* Breakfast: South Indian vegetarian meal with coffee/tea.</p>
      <p>* Check-in at the hotel (Standard Check-in: 12:00 Noon).</p>
      <p>* Evening visit to Brihadeeswarar Temple (Big Temple) for darshan & photography.</p>
      <p>* Overnight stay at Thanjavur.</p>
    </div>

    <button class="accordion"><i class="fas fa-archway"></i> DAY - 2 THANJAVUR SIGHTSEEING</button>
    <div class="panel">
      <p>* Morning breakfast at hotel.</p>
      <p>* Visit Saraswathi Mahal Library & Thanjavur Royal Palace.</p>
      <p>* Visit Art Gallery & Museum.</p>
      <p>* Lunch at traditional Tamil restaurant.</p>
      <p>* Explore local markets for Tanjore paintings & handicrafts.</p>
      <p>* Cultural program (optional).</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-bus"></i> DAY - 3 EXCURSION TO DARASURAM & GANGAIKONDA CHOLAPURAM</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Day trip to UNESCO World Heritage temples:</p>
      <p>– Airavatesvara Temple at Darasuram</p>
      <p>– Brihadeeswarar Temple at Gangaikonda Cholapuram</p>
      <p>* Packed lunch or lunch at a local eatery en route.</p>
      <p>* Return to Thanjavur by evening.</p>
      <p>* Dinner and overnight stay.</p>
    </div>

    <button class="accordion"><i class="fas fa-umbrella-beach"></i> DAY - 4 DEPARTURE</button>
    <div class="panel">
      <p>* Breakfast at hotel and check-out.</p>
      <p>* Drop at Thanjavur Railway Station / Bus Stand.</p>
      <p>* Tour Ends with Divine Memories!</p>
    </div>
  </div>
</div>
