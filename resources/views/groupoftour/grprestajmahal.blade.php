...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟 INDIA TAJMAHAL RESERVATION-TOUR 🌟</h2>
        <p class="text-muted mb-5"><i class="bi bi-geo-alt-fill"></i> India , Tajmahal</p>
    </center>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('restajmahal.jpg')}}" style="height: 820px" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
...
<!-- Custom Alert Modal -->
<div class="modal fade" id="bookingAlertModal" tabindex="-1" aria-labelledby="bookingAlertLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content border border-warning rounded-4 shadow-lg">
      <div class="modal-header bg-warning text-dark">
        <h5 class="modal-title" id="bookingAlertLabel">
          <i class="bi bi-calendar2-check-fill me-2"></i> GTHolidays Says
        </h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body fs-6">
        <p class="mb-2">✅ Your GroupOftour reservation has been successfully placed!</p>
        <p>📅 <strong>Booking Date:</strong> 01/01/2026</p>
        <p>⏰ You will receive your final confirmation and payment link <strong>1 month before your departure date</strong>.</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-success rounded-pill" data-bs-dismiss="modal">Got it!</button>
      </div>
    </div>
  </div>
</div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const bookNowBtn = form.querySelector('button[type="submit"]');
    const paymentBtn = document.querySelector('button[data-bs-target="#travelPaymentModal"]');
    
    const bookingAlertModal = new bootstrap.Modal(document.getElementById('bookingAlertModal'));
    ...
    paymentBtn.addEventListener('click', function (e) {
        e.preventDefault();
        alert("⚠️ Payment is not required at this stage.\n\nThis is a reservation-only tour. You will receive payment instructions one month before departure.");
    });
});
</script>
...
<div class="container my-3">
  <h2>TAJ MAHAL TOUR (DAY WISE)</h2>
  <div class="internity">

    <button class="accordion"><i class="fas fa-plane-arrival"></i> DAY - 1 ARRIVAL IN DELHI</button>
    <div class="panel">
      <p>* Arrival at Delhi Airport / Railway Station.</p>
      <p>* Meet and greet by our tour representative.</p>
      <p>* Transfer to hotel and check-in.</p>
      <p>* Visit India Gate, Rashtrapati Bhavan (Drive Past), and Qutub Minar.</p>
      <p>* Overnight stay at hotel in Delhi.</p>
    </div>

    <button class="accordion"><i class="fas fa-landmark"></i> DAY - 2 DELHI TO AGRA</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Drive to Agra (Approx. 3.5 hrs).</p>
      <p>* Visit Agra Fort and Mehtab Bagh (sunset view of Taj Mahal).</p>
      <p>* Evening at leisure or explore local handicrafts.</p>
      <p>* Overnight stay at hotel in Agra.</p>
    </div>

    <button class="accordion"><i class="fas fa-monument"></i> DAY - 3 TAJ MAHAL VISIT - JAIPUR</button>
    <div class="panel">
      <p>* Early morning visit to the **Taj Mahal** at sunrise.</p>
      <p>* Return to hotel for breakfast and check-out.</p>
      <p>* Drive to Jaipur (Approx. 5 hrs), enroute visit Fatehpur Sikri.</p>
      <p>* Check-in and relax at hotel in Jaipur.</p>
      <p>* Overnight stay in Jaipur.</p>
    </div>

    <button class="accordion"><i class="fas fa-city"></i> DAY - 4 JAIPUR CITY TOUR</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Visit Amber Fort (Elephant ride optional), City Palace, and Jantar Mantar.</p>
      <p>* Stop by Hawa Mahal for photos.</p>
      <p>* Shopping in local bazaars for handicrafts and souvenirs.</p>
      <p>* Overnight stay at hotel in Jaipur.</p>
    </div>

    <button class="accordion"><i class="fas fa-plane-departure"></i> DAY - 5 JAIPUR TO DELHI - DEPARTURE</button>
    <div class="panel">
      <p>* Breakfast and check-out from hotel.</p>
      <p>* Drive back to Delhi (Approx. 5 hrs).</p>
      <p>* Drop-off at Delhi Airport / Railway Station.</p>
      <p>* Tour ends with unforgettable memories of the Taj Mahal and Royal Rajasthan.</p>
    </div>
