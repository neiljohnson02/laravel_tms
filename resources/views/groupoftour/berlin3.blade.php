...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟 GERMANY CITY OF BERLIN TOUR 🌟</h2>
        <p class="text-muted mb-5"><i class="bi bi-geo-alt-fill"></i> GERMANY, Beauty of Berlin City</p>
    </center>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('groupoftourberlin2.jpg')}}" style="height: 820px" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
...
<div class="container my-3">
  ...
  <div class="internity">
    <button class="accordion"><i class="fas fa-plane-arrival"></i> DAY - 1 ARRIVE IN BERLIN</button>
    <div class="panel">
      <p>* Arrival at Berlin Brandenburg Airport (BER).</p>
      <p>* Meet & greet by our local tour representative.</p>
      <p>* Breakfast: Continental breakfast with European delicacies.</p>
      <p>* Transfer to hotel and check-in (Standard check-in time: 15.00 Hrs).</p>
      <p>* Evening: Leisure stroll through Alexanderplatz and Berlin Cathedral area.</p>
      <p>* Dinner at local German restaurant.</p>
      <p>* Overnight stay at hotel in Berlin.</p>
    </div>

    <button class="accordion"><i class="fas fa-monument"></i> DAY - 2 BERLIN CITY TOUR</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Guided Berlin city tour: Visit Brandenburg Gate, Reichstag, Checkpoint Charlie, Berlin Wall Memorial.</p>
      <p>* Visit to Museum Island (optional entry to Pergamon or Neues Museum).</p>
      <p>* Lunch at a local German or Indian restaurant.</p>
      <p>* Evening boat ride on the River Spree (optional).</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-landmark"></i> DAY - 3 POTSDAM EXCURSION</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Full-day excursion to Potsdam – a UNESCO World Heritage city.</p>
      <p>* Visit Sanssouci Palace and Gardens, Dutch Quarter, and Cecilienhof Palace.</p>
      <p>* Lunch in Potsdam (local café or restaurant).</p>
      <p>* Return to Berlin in the evening.</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>
    ...
    <div class="panel">
      ...
      <p>* Morning free for shopping at Kurfürstendamm or Mall of Berlin.</p>
      <p>* Optional visit to Berlin Zoo or East Side Gallery (based on time).</p>
      <p>* Lunch on your own.</p>
      <p>* Transfer to Berlin Airport for departure.</p>
    </div>
  </div>
</div>
