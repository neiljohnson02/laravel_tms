...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟 INDIA BIGTEMPLE  RESERVATION-TOUR 🌟</h2>
        <p class="text-muted mb-5"><i class="bi bi-geo-alt-fill"></i> India , Pride of TamilNadu</p>
    </center>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('reskerala.jpg')}}" style="height: 820px" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
...
<div class="container my-3">
  <h2>KERALA TOUR (DAY WISE)</h2>
  <div class="internity">
    <button class="accordion"><i class="fas fa-bus"></i> DAY - 1 ARRIVAL AT COCHIN - MUNNAR</button>
    <div class="panel">
      <p>* Arrival at Cochin Airport / Railway Station.</p>
      <p>* Meet and greet by our tour representative.</p>
      <p>* Drive to Munnar (Approx. 4 hrs).</p>
      <p>* Enroute visit Cheeyappara and Valara Waterfalls.</p>
      <p>* Check-in at hotel in Munnar.</p>
      <p>* Overnight stay in Munnar.</p>
    </div>

    <button class="accordion"><i class="fas fa-mountain"></i> DAY - 2 MUNNAR SIGHTSEEING</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Visit Mattupetty Dam, Echo Point, Kundala Lake.</p>
      <p>* Explore Tea Museum and Blossom Park.</p>
      <p>* Lunch at a local restaurant.</p>
      <p>* Evening free for shopping/local walk.</p>
      <p>* Overnight stay in Munnar.</p>
    </div>

    <button class="accordion"><i class="fas fa-tree"></i> DAY - 3 MUNNAR - THEKKADY</button>
    <div class="panel">
      <p>* Breakfast and check-out.</p>
      <p>* Drive to Thekkady (Approx. 3.5 hrs).</p>
      <p>* Check-in at Thekkady hotel.</p>
      <p>* Visit Periyar Wildlife Sanctuary (boating optional).</p>
      <p>* Enjoy Kerala cultural show / spice plantation tour.</p>
      <p>* Overnight stay in Thekkady.</p>
    </div>

    <button class="accordion"><i class="fas fa-water"></i> DAY - 4 THEKKADY - ALLEPPEY HOUSEBOAT</button>
    <div class="panel">
      <p>* Breakfast and drive to Alleppey (Approx. 4 hrs).</p>
      <p>* Check-in to private houseboat.</p>
      <p>* Enjoy traditional Kerala lunch onboard.</p>
      <p>* Cruise through the serene backwaters.</p>
      <p>* Evening tea/snacks and dinner onboard.</p>
      <p>* Overnight stay in the houseboat.</p>
    </div>

    <button class="accordion"><i class="fas fa-plane-departure"></i> DAY - 5 DEPARTURE FROM COCHIN</button>
    <div class="panel">
      <p>* Breakfast onboard and check-out from houseboat.</p>
      <p>* Transfer to Cochin Airport / Railway Station.</p>
      <p>* Tour Ends with Sweet Memories of Kerala!</p>
    </div>
  </div>
</div>
