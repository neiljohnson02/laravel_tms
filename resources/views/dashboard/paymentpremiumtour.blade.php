...
<body>
  ...
  <center>
    <h5 class="pt-4">
       <i class="bi bi-clipboard-data text-dark me-2"></i>  <span class="text-dark">GT HOLIDAYS</span> PREMIUM TOUR PAYMENT Form Submissions
    </h5>
  </center>
  <!-- search box -->
            ...
            <thead>
             ...
             <tbody>
               @foreach($payment as $tours)
                ...
                <td>
                  <!-- Delete -->
                 <form action="{{ route('premiumtourpayment.destroy', $tours->id) }}" method="POST" style="display:inline;" class="delete-form">
                    @csrf
                    @method('DELETE')
                  ...
                  <!-- Email -->
                  <form action="{{ route('premiumtourpayment.email', $tours->id) }}" method="POST" style="display:inline;">
                    @csrf
...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    const baseCost = 30000; // Fixed cost to subtract
