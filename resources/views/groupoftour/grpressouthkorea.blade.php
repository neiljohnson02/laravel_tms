...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟 SOUTHKOREA  Gyeongbokgung  RESERVATION-TOUR 🌟</h2>
        <p class="text-muted mb-5"><i class="bi bi-geo-alt-fill"></i> SOUTHKOREA , Gyeongbokgung</p>
    </center>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('ressouthkorea.jpg')}}" style="height: 820px" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
...
<div class="container my-3">
  <h2>INTERNITY (DAY WISE) - SOUTH KOREA TOUR</h2>
  <div class="internity">
    <button class="accordion"><i class="fas fa-plane-arrival"></i> DAY - 1 ARRIVAL IN SEOUL</button>
    <div class="panel">
      <p>* Arrival at Incheon International Airport.</p>
      <p>* Meet & greet by our tour representative.</p>
      <p>* Breakfast: Korean/Continental at local restaurant.</p>
      <p>* Transfer to hotel for check-in (Standard Check-in time: 15:00 Hrs).</p>
      <p>* Evening: Relax or explore nearby Myeongdong shopping street.</p>
      <p>* Overnight stay at hotel in Seoul.</p>
    </div>

    <button class="accordion"><i class="fas fa-landmark"></i> DAY - 2 SEOUL CITY TOUR - GYEONGBOKGUNG PALACE</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Visit Gyeongbokgung Palace and witness the Royal Guard Changing Ceremony.</p>
      <p>* Explore National Folk Museum and Blue House (from outside).</p>
      <p>* Lunch at a local Korean BBQ restaurant.</p>
      <p>* Visit Insadong Cultural Street and Bukchon Hanok Village.</p>
      <p>* Dinner and Overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-tree"></i> DAY - 3 NAMI ISLAND - PETITE FRANCE</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Full-day excursion to Nami Island – known for K-Drama filming sites.</p>
      <p>* Visit Petite France – French-style cultural village.</p>
      <p>* Lunch at local restaurant near the island.</p>
      <p>* Return to Seoul in the evening.</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-building"></i> DAY - 4 LOTTE WORLD TOWER & HAN RIVER CRUISE</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Visit Lotte World Tower – Observation Deck (Seoul Sky).</p>
      <p>* Lunch at Lotte Tower food court or nearby restaurant.</p>
      <p>* Free time for shopping at COEX Mall or Lotte World Mall.</p>
      <p>* Evening Han River Cruise with views of Seoul skyline.</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>
  </div>
</div>
