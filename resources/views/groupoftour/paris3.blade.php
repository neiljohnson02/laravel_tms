...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟PARIS EIFFILL TOWER🌟</h2>
        <p class="text-muted mb-5"><i class="bi bi-geo-alt-fill"></i> France, Experience With France </p>
    </center>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('groupoftourparis.jpg')}}" style="height: 820px" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
...
<div class="container my-3">
  ...
  <div class="internity">
    <button class="accordion"><i class="fas fa-plane-arrival"></i> DAY - 1 ARRIVE IN PARIS</button>
    <div class="panel">
      <p>* Arrival at Charles de Gaulle Airport, Paris.</p>
      <p>* Meet & greet by our tour representative.</p>
      <p>* Breakfast: French continental breakfast with pastries, juice, and coffee.</p>
      <p>* Transfer to hotel for check-in (Standard Check-in time: 15:00 hrs).</p>
      <p>* Evening: Seine River Cruise with views of illuminated monuments.</p>
      <p>* Overnight stay at hotel in Paris.</p>
    </div>

    <button class="accordion"><i class="fas fa-landmark"></i> DAY - 2 EIFFEL TOWER & PARIS CITY TOUR</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Visit the Eiffel Tower (2nd level access).</p>
      <p>* Panoramic city tour: Arc de Triomphe, Champs-Élysées, Notre-Dame Cathedral, Louvre (outside).</p>
      <p>* Lunch at an Indian or French restaurant.</p>
      <p>* Free time for shopping or exploring Parisian cafés.</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-palette"></i> DAY - 3 VERSAILLES & ART MUSEUM TOUR</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Day trip to Palace of Versailles – Explore royal gardens and Hall of Mirrors.</p>
      <p>* Lunch at a local bistro.</p>
      <p>* Afternoon visit to the Louvre Museum (Mona Lisa, classical art).</p>
      <p>* Optional evening cabaret show (Moulin Rouge).</p>
      <p>* Overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-mountain"></i> DAY - 4 DISNEYLAND OR MONTMARTRE EXPERIENCE</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Option 1: Full-day at Disneyland Paris (rides, shows, parades).</p>
      <p>* Option 2: Explore Montmartre hill, Sacré-Cœur Basilica, and art street culture.</p>
      <p>* Lunch at Disneyland or local Paris café depending on option.</p>
      <p>* Evening leisure time or souvenir shopping.</p>
      <p>* Transfer to airport for departure OR extend stay upon request.</p>
    </div>
  </div>
</div>
