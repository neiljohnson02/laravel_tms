            ...
            <thead>
             ...
             <tbody>
               @foreach($payment as $tours)
                ...
                <td>
                  <!-- Delete -->
                 <form action="{{ route('packeuropepayment.destroy', $tours->id) }}" method="POST" style="display:inline;" class="delete-form">
                    @csrf
                    @method('DELETE')
                  ...
                  <!-- Email -->
                  <form action="{{ route('packeuropepayment.email', $tours->id) }}" method="POST" style="display:inline;">
                    @csrf
