...
use App\Mail\GroupoftourPaymentMail;
use Illuminate\Support\Facades\Mail;
use Illuminate\Support\Facades\Validator;

class GroupoftourPaymentController extends Controller
{
    // Store function
    public function store(Request $request)
    {
        ...
        try {
            $payment = GroupoftourPayment::create($data);
    ...
    {
        $payment = GroupoftourPayment::latest()->get();
        return view('dashboard.groupoftourpayment', compact('payment'));
    }

    // Send payment confirmation email
    public function sendMail($id)
    {
        $tour = GroupoftourPayment::findOrFail($id);
        ...
        try {
            Mail::to($data['email'])->send(new GroupoftourPaymentMail($data));
