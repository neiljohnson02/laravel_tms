  ...
  <img  class="logo ms-4"  src="gt holidays logo.jpg" alt="logo"  width="200" height="70"></a>
    ...
    <div class="collapse navbar-collapse"  id="collapsibleNavbar">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item ">
          <a class="nav-link  text-dark ms-4 "  href="{{route('company')}}" role="button" >COMPANY</a>
          
        </li>

        <li class="nav-item">
          <a class="nav-link  ms-4 text-dark" href="{{route('groupoftour')}}" role="button">GROUP OF TOURS</a>
        </li>

        <li class="nav-item">
          <a class="nav-link  ms-4 text-dark" href="{{route('package')}}" role="button">PACKAGES</a>
        </li> 

        <li class="nav-item">
          <a class="nav-link  ms-4 text-dark" href="{{route('honeymoon')}}">HONEYMOON</a>
        </li>  

        <li class="nav-item">
          <a class="nav-link  ms-4 text-dark" href="{{route('wedding')}}">WEDDING</a>
        </li>
        
        <li class="nav-item">
          <a class="nav-link  ms-4  text-dark" href="{{route('contact')}}">CONTACT</a>
        </li>  <br>  

        <!-- <li class="nav-item">
        <a href="#" class="btn btn-warning text-dark ms-4"  role="button">ENQUIRY FORM</a>
       </li>
           -->
 </ul>
    </div>
...
<center><h3 class="pt-5">Ultimate Group Tour Adventure</h3>
  <div class="container pt-2 my-4">
  <div class="row row-cols-1   row-cols-md-4 g-4">
  <div class="col">
  <div class="card">
  <a href="{{route('dubai3')}}"><img src="dubai ultimate group1.jpg" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
...
<div class="col">
  <div class="card">
  <a href="{{route('australia3')}}"><img src="australia3.jpeg" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
...
<div class="col">
  <div class="card">
  <a href="{{route('tajmahal3')}}"><img src="group of tour 5.jpeg" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
...
<div class="col">
  <div class="card">
  <a href="{{route('goa3')}}"><img src="group of tour 6.jpg" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
...
<center>
  ...
  <div class="col">
  <div class="card">
  <a href="{{route('paris3')}}"><img src="group of tour 7.jpeg" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
  ...
  <div class="col">
  <div class="card">
  <a href="{{route('france3')}}"><img src="group of tour 8.jpg" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
  ...
  <div class="col">
    <div class="card">
      <a href="{{route('usa3')}}"><img src="group of tour 10.jpg"style="height: 350px"  class="card-img-top" alt="..."></a>
      <div class="card-body">
  ...
  <div class="col">
    <div class="card">
      <a href="{{route('mountrush3')}}"><img src="group of tour 11.jpeg"style="height: 350px"  class="card-img-top" alt="..."></a>
      <div class="card-body">
...
<div class="container pt-2 my-4">
  ...
  <div class="col">
  <div class="card">
  <a href="{{route('germany3')}}"><img src="group of tour 13.jpeg" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
...
<div class="col">
  <div class="card">
 <a href="{{route('berlin3')}}"> <img src=" group of tour 12.jpeg" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
...
<div class="col">
  <div class="card">
  <a href="{{route('italy3')}}"><img src="group of tour 14.jpeg" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
  ...
  <div class="col">
    <div class="card">
     <a href="{{route('rome3')}}"> <img src="italy card 3.jpeg" class="card-img-top" alt="..."></a>
      <div class="card-body">
...
<center><h3 class="pt-5">Fully Reserved Exclusive Groups of  Tours</h3>
  <div class="container pt-2 my-4">
  <div class="row row-cols-1   row-cols-md-4 g-4">
  <div class="col">
  <div class="card">
  <a href="{{route('grpresdubai1')}}"><img src="bigtemple1.jpeg" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
  <h5 class="card-title"><p class="text-center"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M480-480q33 0 56.5-23.5T560-560q0-33-23.5-56.5T480-640q-33 0-56.5 23.5T400-560q0 33 23.5 56.5T480-480Zm0 294q122-112 181-203.5T720-552q0-109-69.5-178.5T480-800q-101 0-170.5 69.5T240-552q0 71 59 162.5T480-186Zm0 106Q319-217 239.5-334.5T160-552q0-150 96.5-239T480-880q127 0 223.5 89T800-552q0 100-79.5 217.5T480-80Zm0-480Z"/></svg>Dubai, United Arab Emirates</h5>
  <p class="card-text text-center" ><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="m612-292 56-56-148-148v-184h-80v216l172 172ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-400Zm0 320q133 0 226.5-93.5T800-480q0-133-93.5-226.5T480-800q-133 0-226.5 93.5T160-480q0 133 93.5 226.5T480-160Z"/></svg>3 Nights and 4 Days</p>
  </div>
...
<div class="col">
  <div class="card">
  <a href="{{route('grpreskerala')}}"><img src="kerala3.jpeg" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
  <h5 class="card-title"><p class="text-center"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M480-480q33 0 56.5-23.5T560-560q0-33-23.5-56.5T480-640q-33 0-56.5 23.5T400-560q0 33 23.5 56.5T480-480Zm0 294q122-112 181-203.5T720-552q0-109-69.5-178.5T480-800q-101 0-170.5 69.5T240-552q0 71 59 162.5T480-186Zm0 106Q319-217 239.5-334.5T160-552q0-150 96.5-239T480-880q127 0 223.5 89T800-552q0 100-79.5 217.5T480-80Zm0-480Z"/></svg>Dubai, United Arab Emirates</h5>
  <p class="card-text text-center" ><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="m612-292 56-56-148-148v-184h-80v216l172 172ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-400Zm0 320q133 0 226.5-93.5T800-480q0-133-93.5-226.5T480-800q-133 0-226.5 93.5T160-480q0 133 93.5 226.5T480-160Z"/></svg>3 Nights and 4 Days</p>
  </div>
...
<div class="col">
  <div class="card">
  <a hef="{{route('grprestajmahal')}}"><img src="forbidden4.jpeg" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
  <h5 class="card-title"><p class="text-center"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M480-480q33 0 56.5-23.5T560-560q0-33-23.5-56.5T480-640q-33 0-56.5 23.5T400-560q0 33 23.5 56.5T480-480Zm0 294q122-112 181-203.5T720-552q0-109-69.5-178.5T480-800q-101 0-170.5 69.5T240-552q0 71 59 162.5T480-186Zm0 106Q319-217 239.5-334.5T160-552q0-150 96.5-239T480-880q127 0 223.5 89T800-552q0 100-79.5 217.5T480-80Zm0-480Z"/></svg>India, Tajmahal</h5>
  <p class="card-text text-center" ><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="m612-292 56-56-148-148v-184h-80v216l172 172ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-400Zm0 320q133 0 226.5-93.5T800-480q0-133-93.5-226.5T480-800q-133 0-226.5 93.5T160-480q0 133 93.5 226.5T480-160Z"/></svg>3 Nights and 4 Days</p>
  </div>
...
<div class="col">
  <div class="card">
  <a hef="{{route('grpresgoa')}}"><img src="malysia4.jpeg" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
  <h5 class="card-title"><p class="text-center"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M480-480q33 0 56.5-23.5T560-560q0-33-23.5-56.5T480-640q-33 0-56.5 23.5T400-560q0 33 23.5 56.5T480-480Zm0 294q122-112 181-203.5T720-552q0-109-69.5-178.5T480-800q-101 0-170.5 69.5T240-552q0 71 59 162.5T480-186Zm0 106Q319-217 239.5-334.5T160-552q0-150 96.5-239T480-880q127 0 223.5 89T800-552q0 100-79.5 217.5T480-80Zm0-480Z"/></svg>India, Beach Of Goa</h5>
  <p class="card-text text-center" ><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="m612-292 56-56-148-148v-184h-80v216l172 172ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-400Zm0 320q133 0 226.5-93.5T800-480q0-133-93.5-226.5T480-800q-133 0-226.5 93.5T160-480q0 133 93.5 226.5T480-160Z"/></svg>3 Nights and 4 Days</p>
  </div>
...
<div class="container pt-2 my-4">
  ...
  <div class="col">
  <div class="card">
 <a href="{{url('grpresindonesia')}}"> <img src="indonasia4.jpeg" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
...
<div class="col">
  <div class="card">
  <a href="{{url('grprestokyo')}}"><img src="tokyo4.jpeg" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
...
<div class="col">
  <div class="card">
  <a href="{{url('grpresbankok')}}"><img src="bangkok4.jpeg" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
...
<div class="col">
  <div class="card">
  <a href="{{url('grpressingapore')}}"><img src="singapore4.jpeg" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
...
<div class="container pt-2 my-4">
  ...
  <div class="col">
  <div class="card">
  <a href="{{url('grpreskawasanfalls')}}"><img src="kawasanfalls.jpeg" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
...
<div class="col">
  <div class="card">
 <a href="{{url('grpresturkey')}}"> <img src="galatatower.jpeg" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
...
<div class="col">
  <div class="card">
 <a href="{{url('grpressouthkorea')}}"> <img src="southkorea4.jpeg" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
...
<div class="col">
  <div class="card">
  <a href="{{url('grpresrussia')}}"><img src="russia4.jpeg" style="height: 350px" class="card-img-top" alt="..."></a>
  <div class="card-body">
