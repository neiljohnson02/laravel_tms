...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟SOUTHAFRICA TABLE-MOUNTAIN TOUR 🌟</h2>
        <p class="text-muted mb-5"><i class="bi bi-geo-alt-fill"></i>SouthAfrica, TABLE-MOUNTAIN</p>
    </center>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('packafrica2.jpg')}}" style="height: 820px" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
...
<div class="container mt-3">
  ...
  <div class="carusel bg-light p-4 rounded shadow" style="resize: both; overflow: auto;">
    <div class="form">
      <form id="africaform" method="POST">
        {{csrf_field()}}
      ...
      <!-- Premium Package -->
        <div class="form-group mb-3 col-md-8 ms-5">
          ...
          <select name="package" class="form-control" required>
            <option value="capetown_45k">South Africa, Cape Town – 45k</option>
            <option value="table_mountain_46k">South Africa, Table Mountain – 46k</option>
            <option value="kalahari_47k">South Africa, Kalahari Desert – 47k</option>
            <option value="tanzania_48k">East Africa, Tanzania – 48k</option>
            <option value="victoria_falls_47k">Zimbabwe, Victoria Falls – 47k</option>
            <option value="pyramids_56k">Egypt, Great Pyramid – 56k</option>
            <option value="uganda_western_49k">Uganda, Western Region – 49k</option>
            <option value="madagascar_50k">East Africa, Madagascar – 50k</option>
            <option value="nairobi_20k">Kenya, Nairobi – 20k</option>
            <option value="elmina_castle_18k">Ghana, Elmina Castle – 18k</option>
            <option value="touba_17k">Senegal, Touba – 17k</option>
            <option value="ouzoud_waterfalls_20k">Morocco, Ouzoud Waterfalls – 20k</option>
            <option value="mount_agou_20k">Togo, Mount Agou – 20k</option>
            <option value="namib_desert_18k">Namibia, Namib Desert – 18k</option>
            <option value="gao_17k">Mali, Gao – 17k</option>
          </select>
...
$(document).ready(function(){
  ...
  $('#africaform').submit(function(e){
    e.preventDefault();
    $.ajax({
      url: "{{ route('packafrica.tour') }}",
      type: "POST",
      data: $(this).serialize(),
  ...
  function premiumTours(){
    $.get("{{ route('packafrica.tours') }}", function(data){
...
<div class="container my-3">
  ...
  <div class="internity">
    <button class="accordion"><i class="fas fa-plane-arrival"></i> DAY - 1 ARRIVE IN CAPE TOWN</button>
    <div class="panel">
      <p>* Arrival at Cape Town International Airport.</p>
      <p>* Meet & greet by our representative.</p>
      <p>* Breakfast: South African continental breakfast served.</p>
      <p>* Transfer to hotel for check-in (Standard Check-in time: 15:00 Hrs).</p>
      <p>* Evening leisure walk at V&A Waterfront.</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-mountain"></i> DAY - 2 TABLE MOUNTAIN & CITY TOUR</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Ascend Table Mountain via cableway (weather permitting).</p>
      <p>* Explore panoramic views of Cape Town.</p>
      <p>* Guided city tour including Greenmarket Square, Company Gardens, and Bo-Kaap.</p>
      <p>* Lunch at a local South African restaurant.</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-water"></i> DAY - 3 CAPE PENINSULA TOUR</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Drive along Chapman's Peak, stop at Hout Bay.</p>
      <p>* Visit Cape of Good Hope & Cape Point.</p>
      <p>* Penguin Colony at Boulders Beach.</p>
      <p>* Lunch at seaside restaurant.</p>
      <p>* Return to hotel, dinner and overnight stay.</p>
    </div>

    <button class="accordion"><i class="fas fa-wine-bottle"></i> DAY - 4 WINELANDS EXPERIENCE</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Full-day tour of the Cape Winelands (Stellenbosch, Franschhoek).</p>
      <p>* Wine tasting at selected vineyards.</p>
      <p>* Lunch in a wine estate restaurant.</p>
      <p>* Return to Cape Town, dinner and overnight stay.</p>
    </div>
  </div>
</div>
...
$('#paymentform').on('submit', function(e) {
    ...
    $.ajax({
        type: 'POST',
        url: "{{ route('packafrica-payment.store') }}",
        data: formData,
        contentType: false,
        processData: false,
        success: function(response) {
...
function loadPremiumPayments() {
    $.get("{{ route('packafrica.packafricas') }}", function (data) {
        $('#tourTableContainer').html(data);
    });
}
</script>
