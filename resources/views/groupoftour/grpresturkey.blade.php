...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟 TURKEY  RESERVATION-TOUR 🌟</h2>
        <p class="text-muted mb-5"><i class="bi bi-geo-alt-fill"></i> Turkey ,Beauty of turkey</p>
    </center>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('resturkey.jpg')}}" style="height: 820px" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
...
<div class="container my-3">
  <h2>INTERNITY (DAY WISE) - TURKEY TOUR</h2>
  <div class="internity">
    <button class="accordion"><i class="fas fa-plane-arrival"></i> DAY - 1 ARRIVE IN ISTANBUL</button>
    <div class="panel">
      <p>* Arrival at Istanbul International Airport.</p>
      <p>* Meet & greet by our tour representative.</p>
      <p>* Transfer to hotel for check-in (Standard Check-in time: 14:00 Hrs).</p>
      <p>* Evening: Bosphorus Dinner Cruise with Turkish cultural show.</p>
      <p>* Overnight stay at hotel in Istanbul.</p>
    </div>

    <button class="accordion"><i class="fas fa-city"></i> DAY - 2 ISTANBUL CITY TOUR</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Visit Blue Mosque, Hagia Sophia, Topkapi Palace, and Hippodrome Square.</p>
      <p>* Lunch at local Turkish restaurant.</p>
      <p>* Explore Grand Bazaar for shopping and souvenirs.</p>
      <p>* Dinner and Overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-mountain"></i> DAY - 3 FLY TO CAPPADOCIA - UNDERGROUND CITY TOUR</button>
    <div class="panel">
      <p>* Early morning transfer to airport and flight to Cappadocia.</p>
      <p>* Breakfast onboard or packed.</p>
      <p>* Visit Derinkuyu Underground City and panoramic views of Göreme Valley.</p>
      <p>* Lunch at a cave restaurant.</p>
      <p>* Visit Pasabag (Monks Valley) and Devrent Valley.</p>
      <p>* Dinner and overnight stay at hotel in Cappadocia.</p>
    </div>

    <button class="accordion"><i class="fas fa-hot-air-balloon"></i> DAY - 4 HOT AIR BALLOON & RETURN TO ISTANBUL</button>
    <div class="panel">
      <p>* Optional: Early morning Hot Air Balloon ride (subject to weather).</p>
      <p>* Breakfast at hotel.</p>
      <p>* Visit Avanos pottery village and Love Valley.</p>
      <p>* Afternoon flight back to Istanbul.</p>
      <p>* Dinner and overnight stay at hotel in Istanbul.</p>
    </div>
  </div>
</div>
