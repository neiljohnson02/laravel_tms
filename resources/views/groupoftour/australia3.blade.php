...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">Australia Tours</h2>
        <p class="text-muted mb-5"><i class="bi bi-geo-alt-fill"></i> Australia, The Beauty OF Australia</p>
    </center>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('groupoftouraustralia.jpg')}}" style="height: 820px;" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
...
<div class="container my-3">
  ...
  <div class="internity">
    <button class="accordion"><i class="fas fa-plane-arrival"></i> DAY - 1 ARRIVE AT SYDNEY</button>
    <div class="panel">
      <p>* Arrival at Sydney Airport.</p>
      ...
      <p>* Evening: Sydney Harbour Dinner Cruise.</p>
      <p>* Overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-city"></i> DAY - 2 SYDNEY CITY TOUR</button>
    <div class="panel">
      <p>* Morning breakfast at hotel.</p>
      <p>* Visit Sydney Opera House (outside), Bondi Beach, and Darling Harbour.</p>
      <p>* Explore The Rocks and Mrs Macquarie’s Chair.</p>
      <p>* Lunch at Indian Restaurant.</p>
      <p>* Leisure time for shopping or local exploration.</p>
      <p>* Dinner and Overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-frame"></i> DAY - 3 BLUE MOUNTAINS - WILDLIFE PARK</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Day trip to Blue Mountains: Scenic World rides and Echo Point.</p>
      <p>* Visit Featherdale Wildlife Park (see kangaroos & koalas).</p>
      <p>* Lunch at local restaurant.</p>
      <p>* Return to Sydney for dinner and overnight stay.</p>
    </div>

    <button class="accordion"><i class="fas fa-building"></i> DAY - 4 GOLD COAST - MOVIE WORLD</button>
    <div class="panel">
      <p>* Breakfast and checkout from hotel.</p>
      <p>* Flight to Gold Coast (or transfer).</p>
      <p>* Visit Warner Bros. Movie World.</p>
      <p>* Lunch inside the theme park.</p>
      <p>* Evening leisure at Surfers Paradise beach.</p>
      <p>* Dinner and Overnight stay at Gold Coast hotel.</p>
    </div>
  </div>
</div>
...
function loadPremiumPayments() {
    $.get("{{ route('groupoftour.groupoftours') }}", function (data) {
        $('#tourTableContainer').html(data);
    });
}
</script>
