    ...
    <div class="col-lg-4 col-md-6 mb-4">
      <a href="{{route('honeymoon')}}">
        <div class="gallery-img">
          <img src="packages hmoon2 (2).jpeg" class="w-100 rounded shadow" alt="Honeymoon"/>
          <div class="gallery-overlay"><i class="fas fa-heart"></i> Honeymoon Packages</div>
        </div>
      </a>
      <a href="{{route('packindia')}}">
        <div class="gallery-img mt-3">
          <img src="honeypackages.jpeg" class="w-100 rounded shadow" alt="India Tours"/>
          <div class="gallery-overlay"><i class="fas fa-map-marked-alt"></i> Explore India</div>
        </div>
      </a>
    </div>

    <div class="col-lg-4 col-md-6 mb-4">
      <a href="{{route('packafrica')}}">
        <div class="gallery-img">
          <img src="https://mdbcdn.b-cdn.net/img/Photos/Vertical/mountain2.webp" class="w-100 rounded shadow" alt="Africa"/>
          <div class="gallery-overlay"><i class="fas fa-safari"></i> Africa Adventure</div>
        </div>
      </a>
      <a href="{{route('packamerica')}}">
        <div class="gallery-img mt-3">
          <img src="https://mdbcdn.b-cdn.net/img/Photos/Horizontal/Nature/4-col/img%20(73).webp" class="w-100 rounded shadow" alt="America"/>
          <div class="gallery-overlay"><i class="fas fa-flag-usa"></i> Discover America</div>
        </div>
      </a>
    </div>

    <div class="col-lg-4 col-md-6 mb-4">
      <a href="{{route('packasia')}}">
        <div class="gallery-img">
          <img src="https://mdbcdn.b-cdn.net/img/Photos/Horizontal/Nature/4-col/img%20(18).webp" class="w-100 rounded shadow" alt="Asia"/>
          <div class="gallery-overlay"><i class="fas fa-dragon"></i> Asia Escapes</div>
        </div>
      </a>
      <a href="{{route('packeurope')}}">
        <div class="gallery-img mt-3">
          <img src="https://mdbcdn.b-cdn.net/img/Photos/Vertical/mountain3.webp" class="w-100 rounded shadow" alt="Europe"/>
          <div class="gallery-overlay"><i class="fas fa-archway"></i> Elegant Europe</div>
        </div>
      </a>
    </div>
