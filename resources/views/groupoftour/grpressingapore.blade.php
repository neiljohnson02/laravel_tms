...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟 SINGAPORE RESERVATION-TOUR 🌟</h2>
        <p class="text-muted mb-5"><i class="bi bi-geo-alt-fill"></i>SINGAPORE -Exlore The Beauty Of Singapore</p>
    </center>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('ressingapore.jpg')}}" style="height: 820px" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
...
<div class="container my-3">
  <h2>INTERNITY (DAY WISE) - SINGAPORE</h2>
  <div class="internity">
    <button class="accordion"><i class="fas fa-plane-arrival"></i> DAY - 1 ARRIVAL & NIGHT SAFARI</button>
    <div class="panel">
      <p>* Arrival at Changi International Airport, Singapore.</p>
      <p>* Meet & greet by our representative and transfer to hotel (Check-in time: 14.00 Hrs).</p>
      <p>* Freshen up and relax.</p>
      <p>* Evening: Visit the world-famous Night Safari.</p>
      <p>* Enjoy the Creatures of the Night Show.</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-city"></i> DAY - 2 CITY TOUR & SENTOSA ISLAND</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Half-day city tour: Merlion Park, Marina Bay Sands, Chinatown, Little India.</p>
      <p>* Lunch at a local Indian restaurant.</p>
      <p>* Afternoon: Sentosa Island tour — Cable Car, Madame Tussauds, Wings of Time show.</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-tree"></i> DAY - 3 GARDENS BY THE BAY & UNIVERSAL STUDIOS</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Morning visit to Gardens by the Bay (Cloud Forest & Flower Dome).</p>
      <p>* Proceed to Universal Studios Singapore for full-day adventure.</p>
      <p>* Lunch inside the park (meal coupon included).</p>
      <p>* Enjoy thrilling rides and shows.</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-shopping-cart"></i> DAY - 4 SHOPPING & DEPARTURE</button>
    <div class="panel">
      <p>* Breakfast at hotel and check-out.</p>
      <p>* Free time for shopping at Orchard Road or Bugis Street.</p>
      <p>* Transfer to airport for your return flight.</p>
      <p>* Depart Singapore with unforgettable memories.</p>
    </div>
  </div>
</div>
