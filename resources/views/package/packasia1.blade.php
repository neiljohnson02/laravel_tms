...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟DUBAI United Arab Emirates TOUR 🌟</h2>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('asia1.jpg')}}" style="height: 820px" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
      ...
      <!-- Premium Package -->
        <div class="form-group mb-3 col-md-8 ms-5">
          ...
          <select name="package" class="form-control" required>
            <option value="dubai_uae">Dubai, United Arab Emirates – 25k</option>
            <option value="villagio_qatar">Villagio Mall, Qatar – 20k</option>
            <option value="tajmahal_india">India, Taj Mahal – 15k</option>
            <option value="goa_beach_india">India, Beach of Goa – 18k</option>
            <option value="paris_france">France, Paris – Eiffel Tower – 30k</option>
            <option value="louvre_france">France, Louvre Museum – 28k</option>
            <option value="maafushi_maldives">Maafushi, Maldives – 22k</option>
            <option value="marina_kuwait">Kuwait, Marina Mall – 19k</option>
            <option value="petra_jordan">Jordan, Petra – 26k</option>
            <option value="great_wall_china">China, The Great Wall of China – 35k</option>
            <option value="bali_indonesia">Indonesia, Bali – 24k</option>
            <option value="osaka_castle_japan">Japan, Osaka Castle – 32k</option>
            <option value="big_temple_india">Big Temple, India – 14k</option>
            <option value="kerala_india">Kerala, India – 17k</option>
            <option value="forbidden_city_china">Forbidden City, China – 33k</option>
...
$(document).ready(function(){
  ...
  $('#asiaform').submit(function(e){
    e.preventDefault();
    $.ajax({
      url: "{{ route('packasia.tour') }}",
      type: "POST",
      data: $(this).serialize(),
  ...
  function premiumTours(){
    $.get("{{ route('packasia.tours') }}", function(data){
...
$('#paymentform').on('submit', function(e) {
    ...
    $.ajax({
        type: 'POST',
        url: "{{ route('packasia-payment.store') }}",
        data: formData,
        contentType: false,
        processData: false,
        success: function(response) {
...
function loadPremiumPayments() {
    $.get("{{ route('packasia.packasias') }}", function (data) {
        $('#tourTableContainer').html(data);
    });
}
</script>
