...
$(document).ready(function(){
  ...
  $('#indiaform').submit(function(e){
    e.preventDefault();
    $.ajax({
      url: "{{ route('packindia.tour') }}",
      type: "POST",
      data: $(this).serialize(),
  ...
  function premiumTours(){
    $.get("{{ route('packindia.tours') }}", function(data){
...
$('#paymentform').on('submit', function(e) {
    ...
    $.ajax({
        type: 'POST',
        url: "{{ route('packindia-payment.store') }}",
        data: formData,
        contentType: false,
        processData: false,
        success: function(response) {
...
function loadPremiumPayments() {
    $.get("{{ route('packindia.packindias') }}", function (data) {
        $('#tourTableContainer').html(data);
    });
}
</script>
