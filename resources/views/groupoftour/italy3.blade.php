...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟 ITALY Venice TOUR 🌟</h2>
        <p class="text-muted mb-5"><i class="bi bi-geo-alt-fill"></i> ITALY, The Beauty of Venice</p>
    </center>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('groupoftouritaly.jpg')}}" style="height: 820px" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
...
<div class="container my-3">
  ...
  <div class="internity">
    <button class="accordion"><i class="fas fa-plane-arrival"></i> DAY - 1 ARRIVE IN VENICE</button>
    <div class="panel">
      <p>* Arrival at Venice Marco Polo Airport.</p>
      <p>* Meet and greet by our tour representative.</p>
      <p>* Breakfast: Continental breakfast served with Italian pastries and beverages.</p>
      <p>* Transfer to hotel via private boat taxi.</p>
      <p>* Check-in at hotel (Standard Check-in time: 15:00 Hrs).</p>
      <p>* Evening: Orientation walk near St. Mark’s Square.</p>
      <p>* Dinner at a local Italian restaurant.</p>
      <p>* Overnight stay in Venice.</p>
    </div>

    <button class="accordion"><i class="fas fa-city"></i> DAY - 2 VENICE CITY TOUR</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Guided walking tour: St. Mark’s Basilica, Doge’s Palace, Bell Tower.</p>
      <p>* Gondola ride through the Venetian canals.</p>
      <p>* Visit to Murano (glass-blowing demonstration) and Burano (colorful houses & lacework).</p>
      <p>* Lunch at a traditional trattoria.</p>
      <p>* Free time for shopping and leisure.</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-water"></i> DAY - 3 ISLAND HOPPING & VENETIAN EXPERIENCE</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Full-day tour: Torcello, Murano, and Burano islands.</p>
      <p>* Enjoy seafood lunch at Burano island.</p>
      <p>* Participate in a Venetian mask-making workshop (optional).</p>
      <p>* Return to Venice in the evening.</p>
      <p>* Dinner at a canal-view restaurant.</p>
      <p>* Overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-plane-departure"></i> DAY - 4 DEPARTURE</button>
    <div class="panel">
      <p>* Breakfast at hotel and check-out.</p>
      <p>* Free time depending on flight schedule: Last-minute shopping or café stop.</p>
      <p>* Transfer to Venice Airport via boat taxi.</p>
      <p>* Departure from Venice.</p>
    </div>
  </div>
</div>
