...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟 DUBAI BURJKHALIFA PREMIUM TOUR 🌟</h2>
        <p class="text-muted mb-5"><i class="bi bi-geo-alt-fill"></i> Dubai, United Arab Emirates</p>
    </center>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('dubai1 carousel.jpeg')}}" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
  <img src="{{asset('dubai 2 burjkhalifa.jpeg')}}" class="card-img-top" alt="...">
</div>
</div>
...
<div class="container mt-3">
  ...
  <div class="carusel bg-light p-4 rounded shadow" style="resize: both; overflow: auto;">
    <div class="form">
      <form id="honeymooninternationalform" method="POST">
        {{csrf_field()}}
  ...
  <label for="package" class="form-label">
    <i class="bi bi-gem"></i>Honeymoon International 
  </label>
  <select name="package" class="form-control" required>
    <option value="indonesia_bali_beach">Indonesia, Bali Beach - 60k</option> 
    <option value="newzealand_south_western">New Zealand, South Western - 40k</option> 
    <option value="srilanka_colombo">Colombo, Sri Lanka - 35k</option>
    <option value="maldives_benotata">Maldives, Benotata - 55k</option>
    <option value="mauritius_north_island">North Island, Mauritius - 50k</option>
    <option value="croatia_krka_park">Croatia, Krka National Park - 48k</option>
    <option value="italy_dolomites">Italy, Dolomites - 65k</option>
    <option value="germany_pairy_grothes">Germany, Pairy Grothes - 52k</option>
    <option value="greece_rhodes">Greece, Rhodes - 53k</option>
    <option value="south_africa_capetown">South Africa, CapeTown - 58k</option>
    <option value="australia_ningaloo_reef">Australia, Ningaloo Reef - 62k</option>
    <option value="argentina_puerto_madryn">Argentina, Puerto Madryn - 59k</option>
    <option value="brazil_summerville_resorts">Brazil, Summer Ville Resorts - 54k</option>
    <option value="west_indies_barbados">West Indies, Barbados - 56k</option>
    <option value="france_borabora">France, BoraBora - 64k</option>
    <option value="uruguay_carmelo">Uruguay, Carmelo - 47k</option>
</select>
...
$(document).ready(function(){
  ...
  $('#honeymooninternationalform').submit(function(e){
    e.preventDefault();
    $.ajax({
      url: "{{ route('honeymooninternational.tour') }}",
      type: "POST",
      data: $(this).serialize(),
      success: function(response){
        if(response.success){
          alert("Tour submitted successfully!");
          $('#honeymooninternationalform')[0].reset();
          premiumTours();
        }
      },
      error: function(xhr){
  ...
  function premiumTours(){
    $.get("{{ route('honeymooninternational.tours') }}", function(data){
...
<div class="container my-3">
  ...
  <div class="internity">
    <button class="accordion"><i class="fas fa-plane-arrival"></i> DAY - 1 ARRIVE AT DUBAI</button>
    <div class="panel">
      <p>* Arrival at Dubai / Abu Dhabi Airport.</p>
      <p>* Our tour representative meets & greets you.</p>
      <p>* Breakfast: Continental and cooked items served with beverages.</p>
      <p>* Transfer to hotel for check-in (Standard Check-in time: 15.00 Hrs).</p>
      <p>* Evening: Dhow cruise buffet dinner.</p>
      <p>* Overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-city"></i> DAY - 2 DUBAI ABU DHABI</button>
    <div class="panel">
      <p>* Morning breakfast at hotel.</p>
      <p>* Proceed for Abu Dhabi: Visit Sheikh Zayed Grand Mosque, Emirates Palace.</p>
      <p>* City tour: Explore Dubai’s landmarks, culture, and architecture.</p>
      <p>* Lunch at Indian Restaurant.</p>
      <p>* Visit Grand Mosque.</p>
      <p>* Dinner and Overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-frame"></i> DAY - 4 DUBAI FRAME - DESERT SAFARI</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Proceed to Dubai Frame.</p>
      <p>* Lunch at local restaurant.</p>
      <p>* Desert Safari with BBQ dinner.</p>
      <p>* Overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-building"></i> DAY - 4 DUBAI CITY TOUR - BURJ KHALIFA - YACHT</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Dubai city tour: Visit Burj Khalifa, Dubai Mall, Palm Jumeirah.</p>
      <p>* Lunch at an Indian restaurant.</p>
      <p>* Burj Khalifa visit during non-peak hours.</p>
      <p>* Private yacht experience.</p>
      <p>* Dinner and Overnight stay at hotel.</p>
    </div>
  </div>
</div>
                    ...
                    <div class="row">
                       <div class="col-md-6 mb-3">
                          ...
                          <select name="travel_group" class="form-control" required>
                              <option value="india_kashmir_15k">India, Kashmir - 15k</option>
                              <option value="india_manali_16k">India, Manali - 16k</option>
                              <option value="india_alleppey_17k">India, Alleppey - 17k</option>
                              <option value="india_ooty_18k">India, Ooty - 18k</option>
                              <option value="india_dharamshala_17k">India, Dharamshala - 17k</option>
                              <option value="india_shimla_16k">India, Shimla - 16k</option>
                              <option value="india_auli_19k">India, Auli - 19k</option>
                              <option value="india_andaman_nicobar_20k">India, Andaman & Nicobar - 20k</option>
                              <option value="india_lakshadweep_20k">India, Lakshadweep Island - 20k</option>
                              <option value="india_darjeeling_18k">India, Darjeeling, West Bengal - 18k</option>
                              <option value="india_goa_beach_17k">India, Goa Beach - 17k</option>
                              <option value="india_ladakh_20k">India, Ladakh - 20k</option>
                          </select>
                      </div>
...
$('#paymentform').on('submit', function(e) {
    ...
    $.ajax({
        type: 'POST',
        url: "{{ route('honeymooninternational-payment.store') }}",
        data: formData,
        contentType: false,
        processData: false,
        success: function(response) {
...
function loadPremiumPayments() {
   $.get("{{ route('honeymooninternational.payment') }}", function (data) {
    $('#tourTableContainer').html(data);
});
