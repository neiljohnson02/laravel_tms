...
use App\Mail\HoneymooninternationalPaymentMail;

class HoneymooninternationalPaymentController extends Controller
{
    public function store(Request $request)
    {
        ...
        try {
            $payment = HoneymoonInternationalPayment::create($data);
    ...
    {
        $payment = HoneymoonInternationalPayment::latest()->get();
        return view('dashboard.honeymooninternationalpayment', compact('payment'));
    }

    // Send payment confirmation email
    public function sendMail($id)
    {
        $tour = HoneymoonInternationalPayment::findOrFail($id);
        ...
        try {
            Mail::to($data['email'])->send(new HoneymooninternationalPaymentMail($data));
