...
<div class="container py-5">
    <center>
        <h2 class="text-dark fw-bold mb-3">🌟 SINGAPORE KAWASANFALLS RESERVATION-TOUR 🌟</h2>
        <p class="text-muted mb-5"><i class="bi bi-geo-alt-fill"></i> Singapore, KawasanFalls</p>
    </center>
...
<div class="container mt-3" style="borer: 1px solid black">
  ...
  <img src="{{asset('reskawasanfalls.jpg')}}" style="height: 820px" class="card-img-top" alt="...">
</div>
<div class="carousel mb-3">
...
<div class="container my-3">
  <h2>INTERNITY (DAY WISE) - SINGAPORE & KAWASAN FALLS</h2>
  <div class="internity">
    <button class="accordion"><i class="fas fa-plane-arrival"></i> DAY - 1 ARRIVE IN SINGAPORE</button>
    <div class="panel">
      <p>* Arrival at Changi Airport, Singapore.</p>
      <p>* Meet & greet by our tour representative.</p>
      <p>* Transfer to hotel for check-in.</p>
      <p>* Evening visit to Marina Bay Sands SkyPark for panoramic views.</p>
      <p>* Dinner at local hawker center (try chilli crab or laksa).</p>
      <p>* Overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-tree"></i> DAY - 2 SINGAPORE CITY TOUR & GARDENS BY THE BAY</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Full-day city tour: Visit Merlion Park, Chinatown, Little India, and Orchard Road.</p>
      <p>* Explore Gardens by the Bay: Cloud Forest and Flower Dome.</p>
      <p>* Evening light show at Supertree Grove.</p>
      <p>* Dinner and overnight stay at hotel.</p>
    </div>

    <button class="accordion"><i class="fas fa-plane"></i> DAY - 3 FLY TO CEBU - TRANSFER TO KAWASAN FALLS</button>
    <div class="panel">
      <p>* Early morning breakfast and check-out.</p>
      <p>* Flight from Singapore to Mactan-Cebu International Airport.</p>
      <p>* Transfer to Badian, Cebu.</p>
      <p>* Kawasan Falls adventure: Canyoneering, swimming, and waterfall trekking.</p>
      <p>* Lunch at a local eatery near Kawasan Falls.</p>
      <p>* Transfer to hotel in Moalboal or nearby.</p>
      <p>* Dinner and overnight stay.</p>
    </div>

    <button class="accordion"><i class="fas fa-umbrella-beach"></i> DAY - 4 BEACH DAY & DEPARTURE</button>
    <div class="panel">
      <p>* Breakfast at hotel.</p>
      <p>* Relax at Panagsama Beach or White Beach (optional snorkeling).</p>
      <p>* Check-out and transfer to Cebu Airport.</p>
      <p>* Flight back home or next destination.</p>
    </div>
  </div>
</div>
